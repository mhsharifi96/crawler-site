    ...
    def parse_author(self, response):
        for quote in response.css("div.page"):
            yield { 
                ...
                'email_site': quote.css("div.fullContainer > div.profile > div.personalProfile > fieldset.formViewProfile > section.mui-col-md-9 > article.Specifications > div.mui-row > div.mui-col-md-6 > p.description").getall(),
